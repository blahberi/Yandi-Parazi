...
public static class ServiceFactoryExtensions
{
    ...
    public static IServiceFactoryBuilder WithMemberInjection<TImplementation>(this ServiceCreator serviceCreator)
    {
        return serviceCreator.ToFactory().WithMemberInjection<TImplementation>();
    }
}